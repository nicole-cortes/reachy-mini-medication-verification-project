...
from reachy_medication_app.config import LOCKED_PROFILE, config
from reachy_medication_app.openai_realtime import OpenaiRealtimeHandler
from reachy_medication_app.headless_personality_ui import mount_personality_routes
...
class LocalStream:
    ...
    def _persist_api_key(self, key: str) -> None:
        ...
        - Writes/updates ``<instance_path>/.env``:
          ...
          * Else, copies template from ``<instance_path>/.env.example`` when present,
            ...
            ``reachy_medication_app/.env.example``.
    ...
    def _init_settings_ui_if_needed(self) -> None:
        ...
        def _ready() -> JSONResponse:
            try:
                mod = sys.modules.get("reachy_medication_app.tools.core_tools")
