...
# Default editable profile to preselect when the app starts unlocked.
DEFAULT_CUSTOM_PROFILE: str | None = "_reachy_medication_app_locked_profile"
...
class Config:
    ...
    REACHY_MINI_CUSTOM_PROFILE = (
        LOCKED_PROFILE
        or os.getenv("REACHY_MINI_CUSTOM_PROFILE")
        or DEFAULT_CUSTOM_PROFILE
    )
