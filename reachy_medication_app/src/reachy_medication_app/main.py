...
from reachy_medication_app.utils import (
    parse_args,
    setup_logger,
    handle_vision_stuff,
...
def run(
    ...
    from reachy_medication_app.moves import MovementManager
    from reachy_medication_app.console import LocalStream
    from reachy_medication_app.openai_realtime import OpenaiRealtimeHandler
    from reachy_medication_app.tools.core_tools import ToolDependencies
    from reachy_medication_app.audio.head_wobbler import HeadWobbler
    ...
    if args.gradio:
        ...
        from reachy_medication_app.gradio_personality import PersonalityUI
...
class ReachyMedicationApp(ReachyMiniApp):  # type: ignore[misc]
